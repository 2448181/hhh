...
//////////////////////////////////////////////////////////////////////////配置区块////////////////////////////////////////////////////////////////////////
let 哎呀呀这是我的ID啊 = "11"; //实际上这是你的订阅路径，同时也是副WORKER的验证密码【主副worker需一样】支持任意大小写字母和数字，[域名/ID]进入订阅页面
let 哎呀呀这是我的VL密钥 = "aa99a99a-aaaa-9aa9-aa99-9a99aa9a99a9"; //这是真实的UUID，通用订阅会进行验证，建议修改为自己的规范化UUID
...
let 我的优选 = []; // 节点列表
let 我的优选TXT = ["https://raw.githubusercontent.com/AJuines/tianshuyouxuanip/refs/heads/main/ip.txt"]; // 优选TXT路径

let 启用反代功能 = true //选择是否启用反代功能，false，true，现在你可以自由的选择是否启用反代功能了
let 反代IP = "fdip.houyitfg.asia"; //反代IP或域名，支持多反代，会随机挑选一个发往副worker，反代IP端口一般情况下不用填写，如果你非要用非标反代的话，可以填'ts.hpc.tw:443'这样fdip.houyitfg.asia
